        ...
        <div className='mt-5 pt-5'>
            <div className="row container m-auto">
                ...
                <Table striped bordered hover size="sm">
                    <thead>
                        <tr>
                            <th width='5%' className='text-center'>Sl</th>
                            <th width='15%' className='text-center'>Thumbnail</th>
                            <th width='30%' className='text-center'>Service Name</th>
                            <th width='50%' className='text-center'>Review</th>
